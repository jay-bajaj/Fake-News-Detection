...
class ConvEncoder(nn.Module):
    ...
    def forward(self, source): # 1 Mark
        ...
        for conv in self.convolutions:
            ...
            obtained_output=out+source
            source=obtained_output 
        return source
    ...
    def get_convolutions(self, input_dim, num_layers=3): # 0.5 Marks
        ...
        """
        return nn.ModuleList([nn.Conv1d(in_channels=input_dim, out_channels=2*input_dim, kernel_size=3, stride=1, padding=1) for i in range (num_layers)])
